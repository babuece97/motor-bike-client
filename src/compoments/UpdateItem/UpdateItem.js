...
const ItemDetail = () => {
  ...
  <div class="mb-3 xl:w-96">
    ...
    />
       ...
       <div> <button className='focus:outline-none mt-2 text-white bg-blue-400 hover:bg-yellow-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900' >Manage Inventories</button></div>
